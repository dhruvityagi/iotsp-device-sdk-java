...
cd $DEST/app; java -Xmx100m -Djava.net.preferIPv4Stack=true -XX:GCTimeRatio=4 -Djava.util.logging.config.file=logging.properties -jar iot-edge-rule-engine-0.4.0.1-SNAPSHOT-all.jar -s -p -d genericData.data >> $CAF_APP_LOG_DIR/stdout.log 2>&1;
